...
import JobRequirement from '@/scenes/PostJob/JobRequirement';
import Review from '@/scenes/PostJob/Review';
import JobDetails, {
  schema as JobDetailsSchema,
} from '@/scenes/PostJob/JobDetails';
import { MoButton } from '@/components/MoButton';
import { transition, wrapperVariants } from '@/scenes/PostJob/util/variants';
