...
export default function NavBar() {
    ...
    return (
        <>
            <div className={`w-full ${scrolled ? "bg-indigo-400/70" : "bg-indigo-400"} px-6 h-20 bg-indigo-400 text-white flex items-center justify-between fixed top-0 left-0 z-50`}>
             
               
                <div className='px-2 h-full hidden items-center justify-center lg:flex'>
                    <Image className="inline-block h-18 w-12 rounded-full ring-2 ring-white" src="/logo.png" alt="Logo" width={40} height={100} /> 
                    <Link href={'/'} className="px-3 mx-4 text-base font-medium transition-all duration-700 hover:translate-y-2 uppercase" >ExpertBlooms</Link>
                    ...
                    isOpen && (
                        <div ref={ref} className='flex w-full py-2 animate-fade-in-down  bg-indigo-600 transition-all fade duration-1000 absolute top-20 left-0  items-center justify-center flex-col '>
                            <div className='px-2 h-full flex items-center justify-center flex-col py-2 '>
                                <Link href={'/'} onClick={() => setIsOpen(false)} className="px-3  m-4 text-base font-medium transition-all duration-700 hover:translate-y-2 uppercase" >BloomsExpert</Link>
